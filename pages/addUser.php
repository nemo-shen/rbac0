          ...
          <div class="row">
            ...
            <div class="col-md-6" style="width:100%">
              ...
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="../index.php?action=addUser" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">用户名</label>
                      <input style="width: 50%" name="username" type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入用户名">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">密码</label>
                      <input style="width: 50%" name="password" type="password" class="form-control" id="exampleInputPassword1" placeholder="请输入密码">
                    </div>
                  </div><!-- /.box-body -->
