...
$result = $permission->showPermission($_GET['id']);
?>
<!DOCTYPE html>
<html>
  <head>
            ...
            <div class='col-md-12'>
              <div class='box box-info'>
                ...
                <div class='box-body pad' style="width: 50%">
                  <form action="../index.php?action=editPermission&id=<?php echo $result['id'];?>" method="post">
                  <div class="form-group">
                    <label>权限名</label>
                    <input type="text" value="<?php echo $result['name'];?>" name="name" class="form-control my-colorpicker1"/>
                  <br><label>类方法名</label>
                    <input type="text" value="<?php echo $result['fname'];?>" name="fname" class="form-control my-colorpicker1"/>
                  </div><!-- /.form group -->
