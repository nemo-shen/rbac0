...
$list = $permission->permissionList('id,name,pid');
$data = lists($list);
?>
<!DOCTYPE html>
<html>
          ...
          <div class="row">
            ...
            <div class="col-md-6" style="width:100%">
              ...
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="../index.php?action=addPermission" method="post">
                  <div class="box-body">
                    <div class="form-group" style="width:50%;">
                      ...
                      <input name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入权限名">
                      <br><label for="exampleInputEmail1">类方法名</label>
                      <input name="fname" type="text" class="form-control" id="exampleInputEmail1" placeholder="请输入类方法名">
                    </div>
                  </div><!-- /.box-body -->
