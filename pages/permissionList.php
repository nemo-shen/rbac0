            ...
            <div class="col-md-9" style="width:100%">
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  ...
                  <span style="width: 10%; margin-left:10px; display: block;"><a href="addPermission.php"><button class="btn btn-block btn-default">添加权限</button></a></span>
                    ...
                    <style>
                      ...
                      <tbody>
                    <?php 
                    if ($list = $user->permissionList(true)) {
                        $data = lists($list);
                    ?>
                    <thead>
                    	<th>
...
<!--                          <td class="mailbox-subject" style="width:40%"></td>
                          ...
                          <ul class="caozuo">
                          	<li><a href="../index.php?action=editPermission&id=<?php echo $value['id'];?>"><button class="btn btn-block btn-default">编辑</button></a></li>
                          	<li><a href="../index.php?action=delPermission&id=<?php echo $value['id'];?>"><button class="btn btn-block btn-default">删除</button></a></li>
                          </ul>
                          </td>
                        </tr>
                        <?php 
                          ...
                          ?>
                          <tr><span style="marign:10px auto; font-size:100px;">没有权限╮(╯▽╰)╭</span></tr>
                          <?php
                      }
                        ?>
