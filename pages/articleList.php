              ...
              <div class="box box-primary">
                <div class="box-body no-padding">
                  <div class="table-responsive mailbox-messages">
                    ...
                    <thead>
                    	<th>
                        	<td>标题</td><td>内容</td><td></td><td>修改时间</td><td>操作</td>
                        </th>
                    </thead>
                    <style>
                      ...
                      ?>
                        <tr>
                          <td></td>
                          <td class="mailbox-name" style="width:20%"><a href="read-mail.html"><?php echo mb_substr($value['name'], 0, 20);?></a></td>
                          <td class="mailbox-subject" style="width:40%"><?php echo mb_substr($value['content'], 0, 80);?></td>
                          <td class="mailbox-attachment"></td>
                          <td class="mailbox-date" style="width:20%"><?php echo date("Y-m-d H:i:s", $value['time']);?></td>
                          <td class="mailbox-date" style="width:20%">
                          <ul class="caozuo">
                          	<li><a href="../index.php?action=showArticle&id=<?php echo $value['id'];?>"><button class="btn btn-block btn-default">查看</button></a></li>
                          	<li><a href="../index.php?action=editArticle&id=<?php echo $value['id'];?>"><button class="btn btn-block btn-default">编辑</button></a></li>
                          	<li><a href="../index.php?action=delArticle&id=<?php echo $value['id'];?>"><button class="btn btn-block btn-default">删除</button></a></li>
                          </ul>
                          </td>
                        </tr>
                        <?php 
