...
$role = C('role');
$pa_list = $role->paList($_GET['id']);
$pa_data = lists($pa_list);
$result = $role->showRole($_GET['id']);
$permission = C('permission');
$data = $permission->permissionList('id,name,pid', true);
          ...
          <div class="row">
            ...
            <div class="col-md-6" style="width:100%">
              ...
              <div class="box box-primary">
                <!-- form start -->
                <form role="form" action="../index.php?action=editRole&id=<?php echo $result['id'];?>" method="post">
                  <div class="box-body">
                   ...
                   <br><label for="exampleInputEmail1">赋予权限</label>
                   <select name="pid" class="form-control">
                    <option value="0"></option>
                      ...
                      <label for="exampleInputEmail1">角色权限列表</label><br>
                      <ul style="padding: 0px">
                      <?php 
                      if (empty($pa_data)){
                      ?>
                      <li style="list-style:none">该角色没有权限，请尽快添加<span style="font-size: 120px;">:(</span></li>
                      <?php    
                      } else {
                        foreach ($pa_data as $value) {
                      ?>
                        <li class="bg-green-active color-palette" style=" float:left; width:100%; margin: 1px; padding:5px;"><?php echo $value['name'];?><span style=" float:right"><a href="../index.php?action=editRole&pid=<?php echo $value['id'];?>&id=<?php echo $_GET['id']; ?>"><span class="btn btn-block btn-default">删除权限</span></a></span></li>
                        <?php 
                        }
                      }
                        ?>
