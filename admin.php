          ...
          <div class="row">
            ...
            <section class="col-lg-5 connectedSortable" style="width:90%; margin:1% 5%;">
              <div class="box box-solid bg-green-gradient">
               ...
               因为我发现互联网上讲理论的一大堆，但是真正实际开发的模型却没有，至少我没有找到。及时有，那么也肯定是嵌入在其他的开源CMS系统中。<br>
               对于那些动辄几百个文件的大型系统，虽然它们有RBAC，但是对于我们没有接触过的开发者来说，要找出关键点非常的困难。<br>
               ...
               当然，我相信这个实例并不是一个非常好的、安全的、能够直接投入项目中的例子，我也不希望有人会直接将该实例用于项目开发中。<br>
